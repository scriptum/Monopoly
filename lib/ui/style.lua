return {
  button = {
    image = S.newImage('data/gfx/menu-button.dds'),
    ...
    draw = function(s)
      ...
      if s.hover_alpha > 0 and s.disabled == false then
        S.setColor(s.r or 255, s.g or 255, s.b or 255, (s.hover_alpha*s.a)/255)
      ...
      if s.text then
        ...
        if ui_style.button.font_color then 
          ...
          S.setColor(c[1],c[2],c[3],s.a*c[4]/255)
        end
  ...
  slider = {
    image = S.newImage('data/gfx/slider-button.png'),
    button = {
