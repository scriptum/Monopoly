...
reason_jail_2 = {
  ...
  'Когда вы были на экскурсии в тюрьме - сотрудник узнал в Вас опасного преступника. Вас посадили.',
  'Вы ввалились в незнакомое помещение пьяным и с кем-то подрались. За такую наглость начальник тюрьмы распорядился вас арестовать.',
...
rules_group =
{
  auto = {
    ...
    phrase = {               --список фраз, которые пишутся при попадании на группу (выбирается случайно)
      ...
      'Вандалы разбили стекло машины и вытащили магнитолу. Присмотревшись, вы поняли, что и колеса, и двери, и сидения, и все, что было в багажнике, и даже все, что было под капотом. Ремонт обошелся в %'
    }
  },
  oil = {
    image = "drop.png",
  ...
  food = {
    ...
    phrase = {
      ...
      'Вышел закон, по которому мясные продукты теперь должны содержать мясо. Цены подскочили. Расходы составили %'
    }
  },
  bank = {
    image = "bank.png",
    ...
    phrase = {
      ...
      'Долговые банковские векселя аннулированы. Вы несете убытки в размере %'
    }
  },
  inet = {
    image = "web.png",
  ...
  market = {
    ...
    phrase = {
      ...
      'Поход с женой за новыми туфлями обернулся покупкой еще и сумочки, и костюма, и вечернего платья на сумму %'
    }
  },
  it = {
    image = "computer.png",
    ...
    draw = "company",
    phrase = {
      'Вирусная эпидемия накрыла все компьютеры у вас в офисе. За восстановление данных содрали %',
  ...
  mobile = {
    ...
    phrase = {
      ...
      'Вы купили своему ребенку его первый мобильный телефон. Вскоре вам пришел счет за мобильные услуги в размере %',
