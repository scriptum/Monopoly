...
reason_jail_2 = {
	...
	'Вы заключили пари с друзьями, что разыграете полицейского. Сидя в тюрьме, вы начали смутно догадываться, что разыграли вас.'
}
...
action_phrase = {
	...
	company_mortgage= 'Эта компания была заложена владельцем, вы не терпите никаких расходов.',
}
...
rules_group =
{
	...
	oil = {
		...
		phrase = {
			...
			'Внезапно пришла зима, власти были не готовы. Спрос на мазут подскочил, заплатите %',
	...
	bank = {
		...
		phrase = {
			...
			'Вы не прочитали условия по кредиту мелким шрифтом. Дополнательные расходы составили %',
	...
	inet = {
		...
		draw = "company",
		phrase = {
			'Упал сервер. С самой верхней полки. Пришлось менять на новый стоимостью %',
	...
	market = {
		...
		phrase = {
			...
			'Поход с женой за новыми туфлями обернулся покупкой ещё сумочки, костюма, и вечернего платья на сумму %'
		}
	},
	it = {
		image = "computer.png",
	...
	clock = {
		...
		phrase = {
			...
			'Узнав, что ваши часы водоотталкивающие, вы решили проверить. Пришлось купить новые за %'
		}
	},
	chance = {
		image = nil,
	...
	nalog = {
		...
		phrase = {
			...
			'Друзья так много болтали о ваших успехах, что слухи дошли до чиновников. Пришлось дать взятку %',
			...
			'"С Новым Годом!", сказало правительство и увеличило ставки по налогам. Расходы %',
