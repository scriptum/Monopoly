...
--var = 0
--E:new(screen):image('data/gfx/krig_Aqua_button.png'):move(100,100):draggable({bound={100, 500, 100, 100}})
...
E:new(board):draw(dice_draw):move(s1 + 10, s1 + 10)
